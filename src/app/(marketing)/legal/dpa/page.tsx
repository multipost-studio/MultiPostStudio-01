...
export default function DpaPage() {
  return (
    <LegalPage title="Data Processing Addendum" updated="August 2026">
      <h2>Roles</h2>
      <p>You are the data controller; Cadence is the processor acting on your documented instructions.</p>
      ...
      <p>A signable version is available for Team and Enterprise customers — contact legal@cadence.example.</p>
    </LegalPage>
  );
}
