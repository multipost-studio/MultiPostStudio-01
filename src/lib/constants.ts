...
export const PLATFORMS = {
  ...
  x: { label: "X", limit: 280, color: "#111827", supportsFirstComment: true, media: "optional" },
  tiktok: { label: "TikTok", limit: 2200, color: "#111827", supportsFirstComment: false, media: "required" },
  youtube: { label: "YouTube", limit: 5000, color: "#ff0000", supportsFirstComment: false, media: "required" },
  pinterest: { label: "Pinterest", limit: 500, color: "#e60023", supportsFirstComment: false, media: "required" },
  threads: { label: "Threads", limit: 500, color: "#111827", supportsFirstComment: true, media: "optional" },
